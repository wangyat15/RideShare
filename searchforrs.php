...
//        navigator.geolocation.getCurrentPosition(function(sPosition){  // get the current position, but only support https
...
<body onload="initMap()">
  ...
  -->
   ...
   <div class="container">
    <div id="sideleft">
      ...
      <form method="post" onSubmit="return rsvalidate();" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
  ...
  <!--        <a href="index.html" class="button">Search </a></br> -->
          ...
          <a href="myridetrip.php" class="button">Return </a></br>
